...
static input int    Magic_Number = 1834290058; // Magic number
static input double Entry_Amount =     1.00; // Entry lots
       input int    Stop_Loss    =       34; // Stop Loss   (pips)
       input int    Take_Profit  =       64; // Take Profit (pips)

static input string ___0______   = "------"; // --- ADX ---
       input int    Ind0Param0   =       25; // Period
       input double Ind0Param1   =     42.0; // Level

static input string ___1______   = "------"; // --- DeMarker ---
       input int    Ind1Param0   =       14; // Period
       input double Ind1Param1   =     0.18; // Level

static input string ___2______   = "------"; // --- Candle Color ---
       input int    Ind2Param0   =       26; // Min body height [pips]
       input int    Ind2Param1   =        1; // Consecutive candles
...
void InitIndicators(void)
  {
   ...
   // DeMarker (14), Level: 0.18
   indHandlers[0][1][0] = iDeMarker(NULL, 0, Ind1Param0);
...
int GetEntrySignal(void)
  {
   ...
   bool   ind1short = ind1val1 < 1 - Ind1Param1 - sigma && ind1val2 > 1 - Ind1Param1 + sigma;
...
/*STRATEGY CODE {"properties":{"entryLots":1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":34,"takeProfit":64,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"ADX","listIndexes":[3,0,0,0,0],"numValues":[25,42,0,0,0,0]},{"name":"DeMarker","listIndexes":[4,0,0,0,0],"numValues":[14,0.18,0,0,0,0]}],"closeFilters":[{"name":"Candle Color","listIndexes":[0,0,0,0,0],"numValues":[26,1,0,0,0,0]}]} */
