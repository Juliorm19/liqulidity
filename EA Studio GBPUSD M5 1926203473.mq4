...
static input int    Magic_Number = 1926203473; // Magic number
static input double Entry_Amount =     1.00; // Entry lots
       input int    Stop_Loss    =       41; // Stop Loss   (pips)
       input int    Take_Profit  =       46; // Take Profit (pips)

static input string ___0______   = "------"; // --- Moving Average of Oscillator ---
       input int    Ind0Param0   =        5; // Fast EMA
       input int    Ind0Param1   =       37; // Slow EMA
       input int    Ind0Param2   =        5; // MACD SMA
       input double Ind0Param3   =   0.0000; // Level

static input string ___1______   = "------"; // --- Moving Average ---
       input int    Ind1Param0   =       48; // Period
       input int    Ind1Param1   =        0; // Shift

static input string ___2______   = "------"; // --- RSI ---
       input int    Ind2Param0   =       33; // Period
       input int    Ind2Param1   =       74; // Level
...
int GetEntrySignal(void)
  {
   // Moving Average of Oscillator (Close, 5, 37, 5), Level: 0.0000
   double ind0val1  = iOsMA(NULL, 0, Ind0Param0, Ind0Param1, Ind0Param2, PRICE_CLOSE, 1);
   double ind0val2  = iOsMA(NULL, 0, Ind0Param0, Ind0Param1, Ind0Param2, PRICE_CLOSE, 2);
   bool   ind0long  = ind0val1 < Ind0Param3 - sigma && ind0val2 > Ind0Param3 + sigma;
   bool   ind0short = ind0val1 > -Ind0Param3 + sigma && ind0val2 < -Ind0Param3 - sigma;
   ...
   double ind1val3  = iMA(NULL, 0, Ind1Param0, Ind1Param1, MODE_SMA, PRICE_CLOSE, 3);
...
void ManageClose(void)
  {
   // RSI (Close, 33), Level: 74
   double ind2val1  = iRSI(NULL, 0, Ind2Param0, PRICE_CLOSE, 1);
   bool   ind2long  = ind2val1 > Ind2Param1 + sigma;
   bool   ind2short = ind2val1 < 100 - Ind2Param1 - sigma;
...
/*STRATEGY CODE {"properties":{"entryLots":1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":41,"takeProfit":46,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Moving Average of Oscillator","listIndexes":[5,3,0,0,0],"numValues":[5,37,5,0,0,0]},{"name":"Moving Average","listIndexes":[7,0,3,0,0],"numValues":[48,0,0,0,0,0]}],"closeFilters":[{"name":"RSI","listIndexes":[2,3,0,0,0],"numValues":[33,74,0,0,0,0]}]} */
