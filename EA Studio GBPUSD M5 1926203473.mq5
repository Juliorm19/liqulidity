...
void InitIndicators(void)
  {
   ...
   indHandlers[0][0][0] = iOsMA(NULL, 0, Ind0Param0, Ind0Param1, Ind0Param2, PRICE_CLOSE);
   if(Show_inds) ChartIndicatorAdd(0, 1, indHandlers[0][0][0]);
   // Moving Average (Simple, Close, 48, 0)
   indHandlers[0][1][0] = iMA(NULL, 0, Ind1Param0, Ind1Param1, MODE_SMA, PRICE_CLOSE);
   if(Show_inds) ChartIndicatorAdd(0, 0, indHandlers[0][1][0]);
   // RSI (Close, 33), Level: 74
   indHandlers[0][2][0] = iRSI(NULL, 0, Ind2Param0, PRICE_CLOSE);
