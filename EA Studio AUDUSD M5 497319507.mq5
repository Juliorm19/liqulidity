...
static input string News_Currencies   = "AUD,USD,EUR"; // News currencies
...
//+------------------------------------------------------------------+
/*STRATEGY MARKET Premium Data; AUDUSD; M5 */
/*STRATEGY CODE {"properties":{"entryLots":1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":27,"takeProfit":26,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Williams' Percent Range","listIndexes":[5,0,0,0,0],"numValues":[25,-50.3,0,0,0,0]},{"name":"Commodity Channel Index","listIndexes":[5,5,0,0,0],"numValues":[33,86,0,0,0,0]},{"name":"Moving Averages Crossover","listIndexes":[3,0,0,0,0],"numValues":[10,21,0,0,0,0]}],"closeFilters":[{"name":"Pin Bar","listIndexes":[0,0,0,0,0],"numValues":[3,28,0,0,0,0]}]} */
